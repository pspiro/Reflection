...
public class Fireblocks {
	...
	// map stablecoin address to name
	static HashMap<String,String> map = new HashMap<String,String>();
	static void initMap() {
		map.put( busdAddr, "BUSD");
		map.put( rusdAddr, "RUSD");
	}
	
	static String getStablecoinName(String address) throws Exception {
		String name = map.get(address);
		Util.require( S.isNotNull(name), "Error: invalid stablecoin address " + address);
		return name;
	}
