...
public class Fireblocks2 {
	...
	static String body = "{\"operation\":\"TRANSFER\",\"amount\":\".00001\",\"assetId\":\"BNB_BSC\",\"source\":{\"type\":\"VAULT_ACCOUNT\",\"id\":\"4\"},\"destination\":{\"type\":\"ONE_TIME_ADDRESS\",\"oneTimeAddress\":{\"address\":\"0xb016711702D3302ceF6cEb62419abBeF5c44450e\"}},\"priorityFee\":\"1\",\"maxFee\":\"15\",\"note\":\"Created by me\"}";
	

	public static void main(String[] args) throws Exception {
		String pk = prodPk;
		String apiKey = prodApi;
		...
		String nonce = "9dd10f6a-15ae-4248-acf6-245796159f4d";
		...
		String signed = Encrypt.signRSA( input, pk);
		S.out( "Sig:");
		...
		client.prepare(op, base + endpoint)
