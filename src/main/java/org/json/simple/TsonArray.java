...
public class TsonArray<T extends JsonObject> extends ArrayList<T> implements JSONAware, JSONStreamAware {
	...
	public T getJsonObj( int i) throws Exception {  // this is not needed, remove. pas
		return super.get(i);
	}
	...
	public T find(String tag, String value) throws Exception {
		for (T item : this) {
